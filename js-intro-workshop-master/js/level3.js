...
var mediaLinks = document.querySelectorAll('li')
// for each of the nodes in the mediaLinks list
// print out the value.
...
//ourTitle.textContent = 'Let us learn things good!';
//console.log(ourTitle.textContent);
...
var OurImg = document.querySelector('img');
